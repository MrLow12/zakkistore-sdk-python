...
Jika opsi `auto_withdraw=True` diaktifkan, SDK akan memicu penarikan dana VA bank otomatis secara *real-time* menjadi saldo utama aplikasi (aplikasi Zakki Store) ketika fungsi `checkbank()` dipanggil.
